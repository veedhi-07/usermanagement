  ...
  "
      > 
        ...
        <div className="flex flex-row">
          ...
          <span>
            <div className="pt-3 text-lg cursor-pointer">Direct Messages</div>
          </span>
          <span>
            <div className="pt-3 pl-13 cursor-pointer">
            <PlusIcon 
            size={24}
        ...
        <div className="flex flex-row">
        <span>
        <div className="pt-4 cursor-pointer pt-49">
        <ChevronDown size = {20} />
        </div>
        </span>
        <span>
        <div className="pt-3 text-lg cursor-pointer pt-48">Spaces</div>
        </span>
        </div>
